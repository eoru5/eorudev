...
const ResumeLink = () => {
  return (
    <SVGLink
      ...
      target='_self'
      path={
        <path className="fill-white group-hover:fill-[url(#hover-gradient)]" d="M34.395,0H9.522c-2.762,0-5,2.239-5,5v33.916c0,2.761,2.238,5,5,5h24.871c2.762,0,5-2.239,5-5V5
