...
const particle = (maxX, maxY, speed) => {
    ...
    const resizeCanvas = () => {
      ...
      if (particles.length === 0) {
        ...
        for (let i = 0; i < particleCount; i++) {
          particles[i] = particle(canvas.width, canvas.height, speed);
        }

        if (interactive) {
          mouseParticle = particle(canvas.width, canvas.height, 0);
